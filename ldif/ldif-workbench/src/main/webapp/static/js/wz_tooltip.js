...
config. BgColor			= '#e5e6f6'	// Background colour (HTML colour value, in quotes)
config. BgImg			= ''		// Path to background image, none if empty string ''
config. BorderColor		= '#888cb4'
...
function tt_MkTipSubDivs()
{
	...
	tt_aElt[0].innerHTML =
		(''
		+ (tt_aV[TITLE].length ?
			('<div id="WzTiTl" style="position:relative;z-index:99999;">'
			...
			+ '</tr></tbody></table></div>')
			: '')
		+ '<div id="WzBoDy" style="position:relative;z-index:99999;">'
...
function tt_Show()
{
	...
	css.zIndex = Math.max((window.dd && dd.z) ? (dd.z + 2) : 0, 99999);
