...
object Main
{
  ...
  private def executeLinkingPhase(config: LdifConfiguration, r2rReader: Seq[QuadReader]): QuadReader = {
   ...
   */
  private def mapQuads(mappingFile: File, readers: Seq[QuadReader]) : Seq[QuadReader] = {
