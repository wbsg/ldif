...
//    for (q <- ldifOutput) print(q.toLine)
    ...
    val correctQuads = CommonUtils.getQuads(List(
      ...
      "<http://en.wikipedia.org/wiki/Ubatuba> <http://ldif.wbsg.de/lastUpdate> \"2011-07-26T18:49:34Z\"^^<http://www.w3.org/2001/XMLSchema#dateTime> <http://ldif.wbsg.de/provenance>.",
      "<http://pt.wikipedia.org/wiki/Ubatuba> <http://ldif.wbsg.de/lastUpdate> \"2010-07-26T18:52:08Z\"^^<http://www.w3.org/2001/XMLSchema#dateTime> <http://ldif.wbsg.de/provenance>.",
      "<http://en.wikipedia.org/wiki/Ubatuba> <http://www.w3.org/1999/02/22-rdf-syntax-ns#type> <http://ldif.wbsg.de/ImportedGraph> <http://ldif.wbsg.de/provenance>.",
      "<http://pt.wikipedia.org/wiki/Ubatuba> <http://www.w3.org/1999/02/22-rdf-syntax-ns#type> <http://ldif.wbsg.de/ImportedGraph> <http://ldif.wbsg.de/provenance>.",
