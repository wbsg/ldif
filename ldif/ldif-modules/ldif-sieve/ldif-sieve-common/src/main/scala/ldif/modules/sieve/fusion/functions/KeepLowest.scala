...
/**
 * Fusion function that keeps the worst rated value according to a given quality assessment metric.
 *
 * @author volhabryl
 */

class KeepLowest(metricId: String) extends FusionFunction(metricId) {
